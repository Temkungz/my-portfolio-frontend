...
const text = { //ส่วนของ text ที่ใช้แสดง transition เมื่อเปลื่ยน route path
    initial: {
        opacity: 1, 
    },
    enter: {
        ...
        transitionEnd: {top: "50.5%"} //ตอนจบ transition ใช้ 47.5% เพราะจะได้ responsive ไม่ติดค่าตายตัวของ px
    },
    exit: {
        opacity: 1,
        top: "40%",
